...
const APPWRITE_DATABASE_ID = process.env.APPWRITE_DATABASE_ID || "resumate";
const APPWRITE_RESUMES_COLLECTION_ID =
  process.env.APPWRITE_RESUMES_COLLECTION_ID || "resumes";
const APPWRITE_TEX_BUCKET_ID =
  process.env.APPWRITE_TEX_BUCKET_ID || "resumate-tex-files";
